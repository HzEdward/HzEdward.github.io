      ...
      <nav class="navbar-static-top" role="navigation">  
       <a class="navbar-minimalize minimalize-styl-2" href="#">
        ...
        <ul class="nav navbar-top-links navbar-right">
          <li class="hidden-xs"> <a href="#" data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-check"></i> {if get_session('lid')==1}人工智能学院{else if get_session('lid')==2}English{end if}</a> <ul class="dropdown-menu animated fadeIn m-t-xs">
              <li><a href="?lang=ch">人工智能学院</a> </li>
              {if get_session('admingid')==1}
              <li><a href="http://web.5yt.cn/_admin999">信电学院</a> </li>
              {/if}
            </ul></li>      
...
{else}
<div >
      <iframe class="J_iframe" name="iframe0"  id="main" width="100%" height="100%" style="min-height:600px;"  frameborder="0" src="{$ADMIN_PATH}?act=error"  data-id="?act=error"  seamless></iframe>
    </div>
{/if}
