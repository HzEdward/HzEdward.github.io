        ...
        <div class="tabs-container">
          ...
          <div class="tab-content">
            <div id="tab-1" class="tab-pane active">
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <code>不建议后台管理目录使用admin！</code>                  
                  {/if}
                  <a onclick="newadmin()" class="label label-danger ">修改后台地址</a></span> </div>
                <div class="form-group">
            ...
            <div id="tab-2" class="tab-pane">
              <div class="panel-body">
                ...
                <div class="show-[c:usermark]" id="showuser">
                  <div class="form-group">
                    <label class="col-sm-2 control-label">是否免审</label>
                    <div class="col-sm-2" id="usermark">
                      <input type="checkbox"  name="useronoff"  value="1" class="js-switch" {$check_onoff [c useronoff],"checked"}>
                      <span class="help-block m-b-none">{$check_onoff [c useronoff],'ch'}</span> </div>
                    <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 开启为免审，关闭为必审</span> </div>
                  <div class="form-group">
              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                   ...
                   <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 修改需要有目录更改权限，<a onclick="newwap()" class="label label-primary ">我想修改</a></span></div>
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <select  class="form-control" name="smsserver">
                        <option value="1"  {$check_onoff [c smsserver],"selected",'',1}>动动客</option>
                        <option value="2"  {$check_onoff [c smsserver],"selected",'',2}>阿里云</option>
                      </select>
                    </div>
                    <span class="help-block m-b-none"><a href="https://www.kancloud.cn/zzzcms/help/2274179" target="_blank">查看帮助</a> </span> </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="password" value="[c:smspw]" name="smspw" id="smspw" class="form-control">
                    </div>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" value="[c:smscode]" name="smscode" id="smscode" class="form-control">
                    </div>
                    <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 短信模板ID</span> </div>

                   <div class="form-group">
                    <label class="col-sm-2 control-label">签名名称</label>
                    <div class="col-sm-4">
                      <input type="text" value="[c:smssign]" name="smssign" id="smssign" class="form-control">
                    </div>
                    <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 短信签名名称</span> </div>
            ...
            <div id="tab-6" class="tab-pane">
              <div class="panel-body">
                <div class="form-group">
                  <div class="alert alert-info col-sm-10 col-md-offset-1"> zzzcms系统默认支持Mysql/sqlite数据库，<a href="http://zzzcms.com/a/case/8_181_1.html"  class="btn btn-success" target="_blank">申请转换数据</a> </div>
                </div>
				  <div class="form-group">
