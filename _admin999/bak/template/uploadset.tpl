                ...
                <div class="form-group">
                 ...
                 <div class="show-[c:watermark]" id="showwater">
                  ...
                  <div class="form-group">
                    ...
                    <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 文字水印需要将字体文件复制到您网站根目录下，并命名为[water.ttc]，本地电脑中ttc格式字体文件均可</span> </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                     ...
                     <div class="col-sm-1">
                      <button type="button" class="btn btn-primary btn-upload" onclick="open_upload('image','1','logo','watermarkpic')"><i class="fa fa-upload"></i> 上传</button>
                    </div>
                    <div class="col-sm-2"> <img src="[c:watermarkpic]" height="30" id="img_watermarkpic"></div>
                  </div>
                  <div class="form-group">
                    ...
                    <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 小于此宽度的图片不加水印</span> </div>
                  <div class="form-group">
                    ...
                    <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 小于此高度的图片不加水印</span> </div>
                  <div class="form-group">
                    ...
                    <span class="help-block m-b-none"><i class="fa fa-info-circle"></i> 默认:90，数字10-100,png水印不支持透明度</span> </div>
                  <div class="form-group">
