              ...
              <div class="panel-body">
                ...
                <div class="form-group">
                 ...
                 <span class="input-group-btn">
                    <button type="button" class="btn btn-primary btn-upload" onclick="open_upload('image','1','sort','spic')"><i class="fa fa-upload"></i> 上传</button>
                  </span>
                   </div> </div>
                ...
                <div class="form-group">
                  ...
                  <span class="input-group-btn">
                    <button type="button" class="btn btn-primary btn-upload" onclick="open_upload('image','1','sort','sico')"><i class="fa fa-upload"></i> 上传</button>
                  </span>
                   </div> </div>
