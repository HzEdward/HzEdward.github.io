          ...
          <div id="tab-1" class="tab-pane active">
            <div class="panel-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <button type="button" class="btn btn-primary btn-upload" onclick="open_upload('image','1','logo','pclogo')"><i class="fa fa-upload"></i> 上传</button>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
                   <button type="button" class="btn btn-primary btn-upload" onclick="open_upload('image','1','logo','waplogo')"><i class="fa fa-upload"></i> 上传</button>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
                   <button type="button" class="btn btn-primary btn-upload" onclick="open_upload('image','1','logo','weixin')"><i class="fa fa-upload"></i> 上传</button>
                </div>
            ...
            <div class="panel-body">
              ...
              <div class="form-group">            
                ...
                <div class="input-group">
                  ...
                  <span class="input-group-addon btn"  onClick="openmap()">打开地图定位</span> </div>
                </div>      
              <label class="col-sm-2 control-label">百度地图AK</label>
                <div class="col-sm-4">
                <div class="input-group">
                  <input type="text"  name="baidumapAK" id="baidumapAK" placeholder="开启ssl协议后，必须使用百度地图AK" value="{$hidestr $conf['baidumapAK'],8}" class="form-control">
                  <a class="input-group-addon btn" href="http://help.zzzcms.com/2128236" target="_blank">使用帮助</a> </div>
                  </div>      
              </div>
              <div class="form-group">
...
function openmap(){layer.open({type:2,area:['1000px','600px'],fix:false,maxmin:true,content:'?act=baidumap',end:function(index,layero){$("#companymappoint").focus();}});}
</script>
</body>
</html>