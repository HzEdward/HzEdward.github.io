    ...
    <div class="tabs-container" style="max-width:900px;">
      ...
      <div class="tab-content">
        <div id="tab-1" class="tab-pane active">
          ...
          <div class="col-sm-5">
            <input type="text" value="[r:b_filename]"  id="pytitle" name="b_filename" id="b_filename" class="form-control"  placeholder="如xiaomi，只允许字母和数字"  onkeyup="this.value=this.value.replace(/[^a-zA-Z0-9]/g,'')">
          </div>
          </div> 
             <div class="form-group">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <label class="col-sm-1 control-label">缩略图</label>
                <div class="col-sm-8"> <input type="text" name="b_pic" id="indexpic" class="form-control" value="[r:b_pic]" placeholder="下方相册上传后选择"></div>
                   <div class="col-sm-2"><button type="button" class="btn btn-info btn-upload" id="pic_upload" onclick="open_upload('image','1','brand','indexpic')"><i class="fa fa-upload"> </i> 选择</button></div>
                  <div class="col-sm-1"> <img src="[r:b_pic]" id="img_indexpic" height="34" > </div>              
            </div>
            <div class="form-group">
              <label class="col-sm-1 control-label">相册</label>
              <div class="col-sm-11">
                <div class="pic_upload"  onclick="open_upload('image','0','brand')">
                  <div class="upload_icon"></div>
                </div>
                <div class="pic_list">
                  <ul class='filelist' id="img_list">
                    {$get_pics [r b_picsurl],[r b_picsname],[r b_pic],'brand'} 
                  </ul>
                </div>
              </div>          
