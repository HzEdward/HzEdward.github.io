var $table = $("#table"), $remove = $("#remove"),$move = $("#move"),$copy = $("#copy"),$del = $("#del"),$recovery=$("#recovery"),ids="",prefix="zzz811_"; 
...
function opennewfull(url){layer.open({type:2,shade:0.8, maxmin: true, area:['90%','95%'],content:url});}
