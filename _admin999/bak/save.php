...
function save_brand(){
	...
	$b_pic=$b_pic ?: count($b_picsurl)>0 ? $b_picsurl[0] : '';	
...
function save_content(){
	...
	$c_mid=get_session("adminid");
	$c_mname=get_cookie("adminname");
	...
	$colarr=array('c_title'=>$c_title,'c_title2'=>$c_title2,'c_lid'=>get_session("lid"),'c_sid'=>$c_sid,'istop'=>$istop,'isgood'=>$isgood,'ispic'=>$ispic,'c_gid'=>$c_gid,'c_visits'=>$c_visits,'c_star'=>$c_star,'c_brand'=>$c_brand,'c_type'=>$c_type,'c_color'=>$c_color,'c_link'=>$c_link,'c_tag'=>$c_tag,'c_content'=>$c_content,'c_addtime'=>$c_addtime,'c_picsurl'=>$c_picsurl,'c_picsname'=>$c_picsname,'c_pic'=>$c_pic,'c_downurl'=>$c_downurl,'c_downname'=>$c_downname,'c_pagename'=>$c_pagename,'c_pagetitle'=>$c_pagetitle,'c_pagekey'=>$c_pagekey,'c_pagedesc'=>$c_pagedesc,'c_exc'=>$c_exc);
	...
	if ($cid==0){
		...
		arr_add($colarr,'c_mid',$c_mid);
		arr_add($colarr,'c_mname',$c_mname);
