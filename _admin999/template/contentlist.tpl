  ...
  <div class="ibox float-e-margins">  
      <div class="row row-lg"> 
        ...
        <div class="ibox-content">
            <div id="toolbar">
              <div class="col-sm-6">
               <button id="add" onClick="opennew('?act=content&stype=[r:s_type]&sid=[r:sid]')" class="btn btn-primary div-block" type="button"><i class="fa fa-plus"></i> 添加</button>
               <button id="add" onClick="opennewfull('?act=content&stype=[r:s_type]&sid=[r:sid]')" class="btn btn-primary div-hidden" type="button"><i class="fa fa-plus"></i> 添加</button>
           ...
           <table {zzz:table} data-url="function.php?act=contentlist&id=[r:sid]&type=[r:s_type]">
              <thead>
                <tr>
                  ...
                  <th class="tabletype text-center" data-field="link" >访问</th>     
                  <th class="tabletitle" data-field="c_title"  data-sortable="true">标题</th>                  
                  <th class="tabletype text-center" data-field="c_sid"  data-sortable="true">分类</th>
                  <th class="tablename text-center" data-field="c_addtime"  data-sortable="true">时间</th>
                  <th class="tabletype text-center" data-field="c_user" >发布者</th>
                  <th class="tabletype text-center" data-field="c_onoff" data-sortable="true">状态</th>
                  <?php if(get_session("admingid")<=2)echo '<th class="tabletype text-center"  data-field="istop" data-sortable="true">开关</th>'; ?>
                  
                  <th class="tabletype text-center" data-field="edit">操　作</th>
                </tr>
              </thead>
            </table>
          </div>
