...
<style>
	.body_file{width:100%;height:auto;padding:25px;}
	...
	.file_foot{position:fixed;height:80px;border-top:1px #ccc solid;bottom:0px;width:100%;text-align:left;right:10px;}
...
.body_file{width:100%;height:auto;padding:15px;}
.file_head{padding-top:0;flex-align:left;align-items:left;}
.file_body{height: 250px;overflow: auto;}
.file_foot{width:100%;padding-right:15px;}
}
