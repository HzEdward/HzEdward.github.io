          ...
          <div class="ibox float-e-margins"> 
            <div class="ibox-content">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
                 <button type="button" class="btn btn-primary btn-upload" onclick="open_upload('image','1','slide','slide')"><i class="fa fa-upload"></i> 上传</button>
                </div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-2">
                 <button type="button" class="btn btn-primary btn-upload" onclick="open_upload('image','1','slide','style')"><i class="fa fa-upload"></i> 上传</button>
                </div>
