  ...
  <div class="ibox float-e-margins">  
      <div class="row row-lg"> 
          ...
          <table {zzz:table50} data-url="function.php?act=aboutlist&sid={$_get 'sid'}">
              <thead>
                <tr>                
                   <th class="tableid text-center" data-field="sid">ID</th>    
                  <th class="tabletype text-center" data-field="sname" >分类名称</th>     
                  <th class="tabletitle" data-field="a_name">中文名称</th>
                  <!-- <th class="tabletitle" data-field="a_enname">英文名称</th>                        -->
                  <!-- <th class="tabletype text-center" data-field="a_order" data-sortable="true">排序</th>     -->
                  <th class="tabletype text-center" data-field="a_onoff">状态</th>                         
                  <th class="tabletype text-center" data-field="edit" class="text-right">编辑</th>
                </tr>
              </thead>
            </table>
        </div>
