          ...
          <div class="panel-body">
            ...
            <div class="form-group">
              <label class="col-sm-1 control-label">缩略图</label>
               <div class="col-sm-8"> <input type="text" name="a_pic" id="indexpic" class="form-control" value="[r:a_pic]" placeholder="下方相册上传后选择"></div>
                   <div class="col-sm-2"><button type="button" class="btn btn-info btn-upload" id="pic_upload" onclick="open_upload('image','1','about','indexpic')"><i class="fa fa-upload"> </i> 选择</button></div>
                  <div class="col-sm-1"> <img src="[r:a_pic]" id="img_indexpic" height="34" > </div>
            </div>
            <div class="form-group">
              <label class="col-sm-1 control-label">相册</label>
              <div class="col-sm-11">
                <div class="pic_upload"  onclick="open_upload('image','0','about')">
                  <div class="upload_icon"></div>
                </div>
                <div class="pic_list">
                  <ul class='filelist' id="img_list">
                    {$get_pics [r a_picsurl],[r a_picsname],[r a_pic],'about'}
                  </ul>
                </div>
              </div>
            </div>
