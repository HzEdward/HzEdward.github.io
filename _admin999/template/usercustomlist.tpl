      ...
      <div class="row row-lg">
        <div class="col-sm-12">
           <div class="ibox-content"><div class="col-sm-5">
            <button id="add" class="btn  btn-primary" type="button" onclick="opennew('?act=usercustom')"><i class="fa fa-plus">　</i>添加参数</button>
            <button onClick="location.reload()" class="btn" type="button"><i class="fa fa-refresh"></i> 刷新</button>
            <button onClick="location.href='?act=userlist'" class="btn" type="button"><i class="fa fa-reply">　</i>返回</button>
          </div>
          <table {zzz:table50}  data-url="function.php?act=customlist&type=user">           
            <thead>
              <tr>
