...
(function( $ ){
  ...
  var methods = {
      init: function(options){
          ...
          header.css('width',options.width+'px').css('height',options.height+4 +'px');
          ...
          if(options.lock == 'height'){
            header.append('<img style="height:' + options.height + 'px" /><span>'+selectValue+'</span>');
          }else{
          ...
          $options.each(function(i,el){
                ...
                dropdown.append('<img onclick="jQuery(\'select[name=' + selectName + ']\').val(\''+ $(el).val() + '\').ImageSelect(\'close\').ImageSelect(\'update\',{val:\''+ $(el).val() + '\',src:\''+ $(el).text() + '\'});" src="' + $(el).text() + '"/>');
          });
      ...
      update:function(options){
          ...
          if($('#'+id + ' .jqis_header').length == 1){
			 ...
			 $('#'+id + ' .jqis_header span').text(options.val);
             ...
             if($('#'+id + ' .jqis_header').attr('lock') == 'height'){
                ...
                $('#'+id + ' .jqis_header img').one('load',function(){
                   ...
                   // $(this).parent().parent().animate({width:$(this).width() + 60});
                    //$('.jqis_dropdown',$(this).parent().parent()).animate({width:$(this).width() + 60});
