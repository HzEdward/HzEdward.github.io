      ...
      <div class="row row-lg">
        <div class="col-sm-12">
          <div class="col-sm-7">
            ...
            <table id="table" data-toggle="table" data-method="post" data-pagination="true" data-search="true" data-show-refresh= "true" data-id-table="advancedtable" data-page-list="[10,50,500]" data-page-size="50" data-content-type="application/x-www-form-urlencoded; charset=UTF-8" data-url="function.php?act=dbsqllist">         
            <thead>
              <tr>
