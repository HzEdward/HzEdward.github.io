...
<div class="wrapper">
  <div class="row">
      <div style="padding:50px;margin:0 auto;text-align:center;border-radius: 5px;position: absolute;left:0;right:0;top:35%;min-width: 400px;">
        <h2>欢迎进入网站管理系统</h2>
        <h3 style="font:16px/40px normal;color:#bbb;"><i class="fa fa-comments"></i> 你好，<?php echo get_cookie('adminname');?>，当前时间为<?php echo date("Y/m/d H:i:s")?>！</h3>
      </div>
  </div>
</div>
</body>
