...
<title><?php echo isset($siteTitle)?$siteTitle:'';?>网站内容管理系统</title>
...
<div class="middle-box loginscreen  animated fadeInDown">
  <div>
   <?php if((isnul(get_session('adminid'))  && isnul(get_cookie('adminname')))) { ?>
  ...
  <?php }elseif(isnul(get_session("adminid"))  && !isnul(get_cookie("adminname"))){ ?>
  <h3>请输入密码直接登陆</h3>
</div>
...
<!--<div class="signup-footer"> Powered by <a href="http://lab.zjgjxh.cn" target="_blank">webcms</a>! Copyright &copy;2015-<?php echo date('Y');?> </div>-->
