...
.lyear-layout-sidebar-close .lyear-aside-toggler .lyear-toggler-bar {
  ...
  <div id="page-wrapper" class="gray-bg dashbard-1"> 
    <div class="row border-bottom" id="navbar" <?php if(get_session('admingid') > 2 ) { ?> style="display: none;"<?php }?>>     
    ...
    <div class="J_mainContent row" id="content-main">
      <iframe class="J_iframe" name="iframe0"  id="main" width="100%" height="100%" style="min-height:600px;"  frameborder="0" src="<?php echo isset($ADMIN_PATH)?$ADMIN_PATH:'';?>?act=right"  data-id="?act=right"  seamless></iframe>
    </div>
  </div>
  <!--右侧部分结束--> 
  <!--右侧边栏开始-->
